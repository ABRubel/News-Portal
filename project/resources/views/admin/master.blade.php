                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="{{route('add-category')}}">Add Slider</a></li>
                            <li><a href="{{route('manage-category')}}">Manage Slider</a></li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        <a href="{{route('manage-comments')}}"><i class="fa fa-table fa-fw"></i>Manage Comments</a>
                    </li>
                    <li>
